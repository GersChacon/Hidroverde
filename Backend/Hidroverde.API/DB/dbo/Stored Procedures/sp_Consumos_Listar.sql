...
BEGIN
    ...
    SELECT
        ...
        co.periodicidad_codigo         AS PeriodicidadCodigo,
        v.notas                        AS Notas,
    ...
    INNER JOIN dbo.Tipos_Recurso tr
        ON tr.tipo_recurso_id = co.tipo_recurso_id
    INNER JOIN dbo.Consumo_Version v
        ON v.consumo_id = co.consumo_id
       AND v.es_actual = 1
    LEFT JOIN dbo.Empleados e
        ON e.empleado_id = v.registrado_por_empleado_id
    WHERE co.activo = 1
